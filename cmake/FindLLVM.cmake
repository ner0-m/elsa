...
function(_find_most_recent_llvm_executable EXECUTABLE_NAME)
  ...
  find_program(${VARNAME}
    NAMES ${EXECUTABLE_NAME}-12.0 ${EXECUTABLE_NAME}120 ${EXECUTABLE_NAME}-12
    ${EXECUTABLE_NAME}-11.1 ${EXECUTABLE_NAME}111
    ${EXECUTABLE_NAME}-11.0.1 ${EXECUTABLE_NAME}1101
    ${EXECUTABLE_NAME}-11.0 ${EXECUTABLE_NAME}110 ${EXECUTABLE_NAME}-11
    ${EXECUTABLE_NAME}-10.0.1 ${EXECUTABLE_NAME}1001
    ${EXECUTABLE_NAME}-10.0 ${EXECUTABLE_NAME}100 ${EXECUTABLE_NAME}-10
    ${EXECUTABLE_NAME}-9.0.1 ${EXECUTABLE_NAME}901
    ${EXECUTABLE_NAME}-9.0 ${EXECUTABLE_NAME}90 ${EXECUTABLE_NAME}-9
    ${EXECUTABLE_NAME}-8.0.1 ${EXECUTABLE_NAME}801
