...
namespace elsa
{
    ...
    class OptimizationProblem : public Problem<data_t> {
    public:
        /**
         ...
         */
        OptimizationProblem(const Functional<data_t>& dataTerm, const std::vector<RegularizationTerm<data_t>>& regTerms,
         ...
         * \param[in] x0 initial value for the current estimated solution
         */
        OptimizationProblem(const Functional<data_t>& dataTerm, const RegularizationTerm<data_t>& regTerm,
                            const DataContainer<data_t>& x0);
         ...
         * \param[in] x0 initial value for the current estimated solution
         */
        OptimizationProblem(const Functional<data_t>& dataTerm, const DataContainer<data_t>& x0);
         ...
         * \param[in] dataTerm functional expressing the data term
         */
        OptimizationProblem(const Functional<data_t>& dataTerm);
    ...
    protected:
        ...
        OptimizationProblem<data_t>* cloneImpl() const override;
