...
namespace elsa
{
    ...
    RegularizationTerm<data_t>::RegularizationTerm(data_t weight, const Functional<data_t>& functional)
    ...
    template <typename data_t>
    RegularizationTerm<data_t>& RegularizationTerm<data_t>::operator=(const RegularizationTerm<data_t>& other)
    {
        if (this != &other) {
    ...
    template <typename data_t>
    RegularizationTerm<data_t>& RegularizationTerm<data_t>::operator=(RegularizationTerm<data_t>&& other)
    {
