...
namespace elsa
{
     ...
     *
     * This class represents a regularization term, consisting of a regularization parameter (a scalar)
     * and a term (represented as a Functional). It is just a light-weight wrapper with no added functionality.
     */
