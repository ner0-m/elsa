...
namespace elsa
{
    ...
    {
        //        index_t width =
        //        this->getDomainDescriptor().getNumberOfCoefficientsPerDimension()[0]; index_t
        //        height = this->getDomainDescriptor().getNumberOfCoefficientsPerDimension()[1];
        //
        ...
        //                }
        //                if (std::abs(k) <= static_cast<index_t>(std::pow(2, j)) - 1) {
        //                    DataContainer<std::complex<real_t>> SHSectionh =
        //                    fft.ifft2(tempSHSectionh);
        //                    // TODO check here
        //                    SHf[i] = SHSectionh; // TODO actually SHSectionh really should only
        //                    have reals i += 1;
        //
        //                    DataContainer<std::complex<real_t>> SHSectionv =
        //                    fft.ifft2(tempSHSectionv);
        //                    // TODO check here
        //                    SHf[i] = SHSectionv;
        //                    i += 1;
        //                } else if (std::abs(k) == static_cast<index_t>(std::pow(2, j))) {
        //                    DataContainer<std::complex<real_t>> SHSectionhxv =
        //                    fft.ifft2(tempSHSectionhxv);
        //                    // TODO check here
        //                    SHf[i] = SHSectionhxv;
        //                    i += 1;
        //                }
        ...
        //        }
        //
        //        DataContainer<std::complex<real_t>> tempSHSectionZero(VolumeDescriptor{{width,
        //        height}}); tempSHSectionZero = 0;
        //
        //        for (int w1 = static_cast<int>(-std::floor(width / 2)); w1 < std::ceil(width / 2);
        //        w1++) {
        //            for (int w2 = static_cast<int>(-std::floor(height / 2)); w2 < std::ceil(height
        //            / 2);
        //                 w2++) {
        ...
        const DataContainer<data_t>& y, DataContainer<data_t>& SHty) const
    {
        ...
        //        DataContainer<std::complex<real_t>> tempSHtcSectionZero(VolumeDescriptor{{width,
        //        height}}); tempSHtcSectionZero = 0;
        //
        //        for (auto w1 = static_cast<int>(-std::floor(width / 2));
        //             w1 < static_cast<int>(std::ceil(width / 2)); w1++) {
        //            for (auto w2 = static_cast<int>(-std::floor(height / 2));
        ...
        //        }
        //
        //        DataContainer<std::complex<real_t>> SHtSectionZero = SHf[i] *
        //        fft.fft2(tempSHtcSectionZero); fHat += SHtSectionZero;
        //
