...
namespace elsa
{
    ...
    public:
         ...
         */
        static void drawFilledEllipse2d(DataContainer<data_t>& dc, data_t amplitude, Vec2 center, Vec2 sizes, data_t angle);
         ...
         */
        static void drawFilledEllipsoid3d(DataContainer<data_t>& dc, data_t amplitude, Vec3 center, Vec3 sizes, data_t phi, data_t theta, data_t psi);
    ...
    private:
         ...
         *
         * This method uses an adapted algorithm from John Kennedy, "A Fast Bresenham Type Algorithm For Drawing Ellipses".
         */
        static void drawShearedFilledEllipse2d(DataContainer<data_t>& dc, data_t amplitude, Vec2 center, Vec2 sizes, Vec2 shear);
