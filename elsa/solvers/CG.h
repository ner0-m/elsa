...
namespace elsa
{
     ...
     * with a symmetric positive-definite operator \f$ A \f$. Some common optimization problems, e.g.
     * weighted least squares or Tikhonov-regularized weighted least squares, can be reformulated as 
     * quadric problems, and solved using CG, even with non-spd operators through the normal equation.
     * Conversion to the normal equation is performed automatically, where possible.
     * 
    ...
    public:
        ...
        /**
         * \brief Constructor for CG, accepting an optimization problem and, optionally, a value for epsilon 
         * 
         * \param[in] problem the problem that is supposed to be solved
         * \param[in] epsilon affects the stopping condition
         * 
         * If the problem is not a QuadricProblem, a conversion will be attempted. Throws if conversion fails.
         * See QuadricProblem for details on problems that are convertible to quadric form.
         */ 
        explicit CG(const Problem<data_t>& problem, data_t epsilon = std::numeric_limits<data_t>::epsilon());

        /**
         * \brief Constructor for preconditioned CG, accepting an optimization problem, the inverse of the preconditioner, 
         *  and, optionally, a value for epsilon 
         * 
         * \param[in] problem the problem that is supposed to be solved
