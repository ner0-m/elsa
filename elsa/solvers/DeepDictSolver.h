...
namespace elsa
{
    ...
    public:
         ...
         */
        DeepDictSolver(DeepDictionaryLearningProblem<data_t>& problem, index_t sparsityLevel,
         ...
         */
        const DeepDictionary<data_t>& getLearnedDeepDictionary();

    private:
        /// keep a reference to the DeepDictionaryLearningProblem
        DeepDictionaryLearningProblem<data_t>& _problem;
