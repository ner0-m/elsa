...
namespace elsa
{
    ...
    class AB_GMRES : public Solver<data_t>
    {
    public:
        /// Scalar alias
         ...
         **/
        explicit AB_GMRES(const LinearOperator<data_t>& projector,
         ...
         * @param[in] epsilon affects the stopping condition
         **/
        AB_GMRES(const LinearOperator<data_t>& projector,
        ...
        /** @brief Solves the given Linear System using AB-AB_GMRES as default, i.e. apply
         *iterations number of iterations of AB_GMRES
