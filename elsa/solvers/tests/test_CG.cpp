        ...
        WHEN("setting up a cg solver") {
            ...
            THEN("the clone works correctly") {
                ...
                AND_THEN("it works as expected") {
                    ...
                    REQUIRE( (scalingOp.apply(solution) - dcB).squaredL2Norm() <= epsilon*epsilon*dcB.squaredL2Norm() );
                }
            }
        }
        ...
        WHEN("setting up a cg solver") {
            ...
            THEN("the clone works correctly") {
                ...
                AND_THEN("it works as expected") {
                    ...
                    // should have converged for the given number of iterations
                    REQUIRE( ((scalingOp+lambdaOp).apply(solution) - dcB).squaredL2Norm() <= epsilon*epsilon*dcB.squaredL2Norm() );
                }
            }
        }
