...
namespace elsa
{
     ...
     *
     * The TransmissionLogLikelihood functional evaluates as \f$ \sum_{i=1}^n (b_i \exp(-x_i) + r_i) - y_i\log(b_i \exp(-x_i) + r_i) \f$,
     * with \f$ b=(b_i) \f$ denoting the mean number of photons per detector (blank scan), \f$ y=(y_i) \f$ denoting the
     * measurements, \f$ r=(r_i) \f$ denoting the mean number of background events, and \f$ x=(x_i) \f$.
     *
     * Typically, \f$ x \f$ is wrapped in a LinearResidual without a data vector, i.e. \f$ x \mapsto Ax \f$.
     */
    ...
    public:
         ...
         */
        TransmissionLogLikelihood(const DataDescriptor& domainDescriptor, const DataContainer<data_t>& y,
        ...
        /**
         * \brief Constructor for transmission log-likelihood, using y, b, and r, and a residual as input
         *
        ...
        /**
         * \brief Constructor for transmission log-likelihood, using y and b, and a residual as input
         *
         * \param[in] residual to be used when evaluating the functional (or its derivative)
         * \param[in] y the measurement data vector
         * \param[in] b the blank scan data vector
