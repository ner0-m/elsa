...
namespace elsa
{
     ...
     *
     * The Huber norm evaluates to \f$ \sum_{i=1}^n \begin{cases} \frac{1}{2} x_i^2 & \text{for } |x_i| \leq \delta \\
     * \delta\left(|x_i| - \frac{1}{2}\delta\right) & \text{else} \end{cases} \f$ for \f$ x=(x_i)_{i=1}^n \f$ and a
     * cut-off parameter \f$ \delta \f$.
     *
    ...
    public:
        /**
         * \brief Constructor for the Huber functional, mapping domain vector to scalar (without a residual)
         *
         ...
         */
        explicit Huber(const DataDescriptor& domainDescriptor, real_t delta = static_cast<real_t>(1e-6));
