...
SCENARIO("Constructing a LinearOperator") {
    GIVEN("DataDescriptors") {
        ...
        IndexVector_t numCoeff2(2); numCoeff2 << 31, 23;
...
SCENARIO("Cloning LinearOperators") {
    GIVEN("a LinearOperator") {
        IndexVector_t numCoeff(3); numCoeff << 23, 45, 67;
        IndexVector_t numCoeff2(2); numCoeff2 << 78, 90;
        DataDescriptor ddDomain(numCoeff);
        DataDescriptor ddRange(numCoeff2);
        LinearOperator linOp(ddDomain, ddRange);
...
SCENARIO("Composite LinearOperator") {
    GIVEN("an additive composite linear operator") {
        IndexVector_t numCoeff(2); numCoeff << 45, 67;
        IndexVector_t numCoeff2(2); numCoeff2<< 13, 48;
        DataDescriptor ddDomain(numCoeff);
        DataDescriptor ddRange(numCoeff2);
    ...
    GIVEN("a multiplicative composite linear operator") {
        IndexVector_t numCoeff(3); numCoeff << 13, 47, 69;
        IndexVector_t numCoeff2(2); numCoeff2 << 15, 28;
        IndexVector_t numCoeff3(4); numCoeff3 << 7, 30, 83, 13;
        DataDescriptor ddDomain(numCoeff);
    ...
    GIVEN("a complex composite with multiple leafs and levels") {
        IndexVector_t numCoeff(2); numCoeff << 13, 38;
        IndexVector_t numCoeff2(1); numCoeff2 << 16;
        IndexVector_t numCoeff3(3); numCoeff3 << 17, 38, 15;
        DataDescriptor ddDomain(numCoeff);
        DataDescriptor ddRange(numCoeff2);
