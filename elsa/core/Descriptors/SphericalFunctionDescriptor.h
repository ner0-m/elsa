 ...
 * \author Matthias Wieczore (wieczore@cs.tum.edu), logic merge with former XTTQuadratureDescriptor and minor adjustments switched to 3D coordinates instead of theta/phi
 * \author Nikola Dinev (nikola.dinev@tum.de), port to elsa
 *
 * \tparam data_t data type of weights and directions
 */
