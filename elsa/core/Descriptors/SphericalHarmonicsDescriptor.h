...
namespace elsa
{
     ...
     * Wieczorek
     * @author Matthias Wieczore (wieczore@cs.tum.edu), logic merge with
    ...
    {
    public:
        // odd for odd functions, even for even functions and regular if the function is neither of
        // those for regular functions, no degrees will be skipped
