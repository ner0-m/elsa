...
namespace elsa
{
    ...
    class ParametrizedVolumeDescriptor : public IdenticalBlocksDescriptor
    {
        ...
        //         const DataDescriptor& volumeDescriptor, const DataDescriptor& basisDescriptor)
        //         const;
        //
    ...
    public:
         ...
         *
         * For a basis of dimension \$N\$, concatenates \$N\$ volume descriptors in a
         * BlockDescriptor. The \$i\$-th descriptor holds the volume parameters w.r.t. the \$i\$-th
         ...
         */
        ParametrizedVolumeDescriptor(const DataDescriptor& volumeDescriptor,
                                     const DataDescriptor& basisDescriptor);
