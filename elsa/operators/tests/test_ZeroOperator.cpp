...
TEST_CASE_TEMPLATE("ZeroOperator: Testing construction, cloning and comparison", data_t, float,
                   double)
{
...
TEST_CASE_TEMPLATE("ZeroOperator: Test apply and applyAdjoint", data_t, float, double,
