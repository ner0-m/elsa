...
TEST_CASE_TEMPLATE("VoxelProjectorCUDA: Calls to functions of super class", TestType,
                   BlobVoxelProjectorCUDA<float>, BlobVoxelProjectorCUDA<double>,
                   PhaseContrastBlobVoxelProjectorCUDA<float>,
                   PhaseContrastBlobVoxelProjectorCUDA<double>, BSplineVoxelProjectorCUDA<float>,
                   BSplineVoxelProjectorCUDA<double>, PhaseContrastBSplineVoxelProjectorCUDA<float>,
